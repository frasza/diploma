...
with sqlite3.connect(DATABASE_PATH) as connection:
    ...
    c.execute("""CREATE TABLE vnosi(vnos_id INTEGER PRIMARY KEY AUTOINCREMENT,
        ...
        stroski TEXT NOT NULL, odobritev TEXT NOT NULL, vpliv TEXT NOT NULL, spol TEXT NOL NULL, starost INTEGER NOT NULL, uporabnik_id INTEGER NOT NULL REFERENCES uporabniki(id), cas TEXT NOT NULL)""")